---
title: What a Tool- Bobbin (Holder)
date: 2026-08-03 14:25:00 -04:00
tags:
- tools
layout: post
---

Let's get the pedantic details out of the way.  Thread (and wire and other stuff) is spooled onto a bobbin.  You put that bobbin (usually of thread) into a bobbin holder [^1] when you tie to keep tension on the thread while you are using the thread to fasten things onto the hook. 
...
Buy one to start.  Down the road, true luxury is having three or four already threaded up and waiting. 
...
* [
Choosing the Right Bobbin with Kelly Galloup](https://www.youtube.com/watch?v=ON3sl2mzmZI&t=344s)
* [Charlie Craven Explains Fly Tying Bobbins](https://www.youtube.com/watch?v=Gb6RvTManeY)