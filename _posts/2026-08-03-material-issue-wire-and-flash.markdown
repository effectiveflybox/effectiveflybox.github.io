...
Both materials come in a to of colors.  I use wire in gold and black.  Use your creativity here.  I find the Ultra Wire product in small is the right size for me.

Krystal flash is mostly just one size, but play around with that too.  Wider flash products produce a different visual effect, and wider sizes may not be as good for tails but they can be used over material to create "backs".  Almost unlimited colors.  I go with plain old pearl but there are lots of cool choices to mess around with.