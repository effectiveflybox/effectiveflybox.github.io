...
I use 12/0 thread for most all of my trout fly tying.  I've used as small as 16/0 and as large as 10/0 and it all works just fine.  The thinner the thread (higher number before the "/0") the less bulk you'll add.  This is a good thing on smaller flies but not so good if you're using the thread to build the shape of the body.  It will still work, but it takes more thread wraps.   

The #/0 measuring of thread can usually get you in the right size ballpark between brands [^1], but the denier measurement system is more accurate.  The Veevus 12/0 thread I use most (of course) doesn't have a published denier rating but tell the folks at the fly shop you're tying flies between size 14 and 10 and they will help you put the right thread on your bobbin. 
